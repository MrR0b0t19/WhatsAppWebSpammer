...
contactos = [
    ...
    "28veintiocho", "29veintinueve", "30treinta",
    "31treinta y uno", "32treinta y dos", "33treinta y tres", "34treinta y cuatro", "35treinta y cinco",
    "36treinta y seis", "37treinta y siete", "38treinta y ocho", "39treinta y nueve", "40cuarenta",
    "41cuarenta y uno", "42cuarenta y dos", "43cuarenta y tres", "44cuarenta y cuatro", "45cuarenta y cinco",
    "46cuarenta y seis", "47cuarenta y siete", "48cuarenta y ocho", "49cuarenta y nueve", "50cincuenta",
    "51cincuenta y uno", "52cincuenta y dos", "53cincuenta y tres", "54cincuenta y cuatro", "55cincuenta y cinco",
    "56cincuenta y seis", "57cincuenta y siete", "58cincuenta y ocho", "59cincuenta y nueve", "60sesenta",
    "61sesenta y uno", "62sesenta y dos", "63sesenta y tres", "64sesenta y cuatro", "65sesenta y cinco",
    "66sesenta y seis", "67sesenta y siete", "68sesenta y ocho", "69sesenta y nueve", "70setenta",
    "71setenta y uno", "72setenta y dos", "73setenta y tres", "74setenta y cuatro", "75setenta y cinco",
    "76setenta y seis", "77setenta y siete", "78setenta y ocho", "79setenta y nueve", "80ochenta",
    "81ochenta y uno", "82ochenta y dos", "83ochenta y tres", "84ochenta y cuatro", "85ochenta y cinco",
    "86ochenta y seis", "87ochenta y siete", "88ochenta y ocho", "89ochenta y nueve", "90noventa",
    "91noventa y uno", "92noventa y dos", "93noventa y tres", "94noventa y cuatro", "95noventa y cinco",
...
def envio(contacto, mensaje):
    try:
        ...
        search_box = driver.find_element(By.XPATH,
                                         '/html/body/div[1]/div/div/div[4]/div/div[1]/div/div[2]/div[2]/div/div[1]/p')  # .double_click()
        # funciones de pantalla con selenium
        search_box.send_keys(Keys.CONTROL, 'a')
        search_box.send_keys(Keys.BACKSPACE)
        search_box = driver.find_element(By.XPATH,
                                         '/html/body/div[1]/div/div/div[4]/div/div[1]/div/div[2]/div[2]/div/div[1]/p')
        ...
        attachment_button = driver.find_element(By.XPATH,
                                                '/html/body/div[1]/div/div/div[5]/div/footer/div[1]/div/span[2]/div/div[2]/div[1]/div/div[1]/p')
        attachment_button.send_keys(Keys.CONTROL, 'v')
        _extracted_from_envio_25(
        ...
        cierre.click()
        _extracted_from_envio_25('//*[@id="app"]/div/span[4]/div/ul/div/div/li[3]/div')
        # validacion de envio
        enviados(contacto)
...
# TODO Rename this here and in `envio`
def _extracted_from_envio_25(arg0):
    attachment_button = driver.find_element(By.XPATH, arg0)
    # time.sleep(.1)
